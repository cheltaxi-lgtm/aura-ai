...
const DAY_PREP = [
  "Мешаю карты для расклада на сутки.",
...
export const copy = {
  ...
  homeHero: (name?: string | null) => {
    ...
    return [
      ...
      "",
      "Все услуги собраны в меню внизу по направлениям: гадания, самопознание, «Моё пространство» и кабинет.",
      "",
      "Выберите направление, затем нужную услугу. Тот же аккаунт, что на zovus.ru.",
    ].join("\n");
  },
  ...
  help: [
    ...
    "/runes — баланс и пополнение через ЮKassa",
  ...
  greeting: (name: string) =>
    [
      ...
      "",
      "Приватный цифровой салон: расклад под вопрос, расклад на сутки и память сессий.",
  ...
  homePhotoFailed: "Салон открыт. Все услуги собраны в меню внизу по направлениям.",
  ...
  weeklyDigest: (p: { streak: number; spreads: number }) =>
    [
      ...
      "",
      "Если хотите — расклад на сутки или новый вопрос ждут в меню.",
    ].join("\n"),
  ...
  profileDobAsk:
    "Напишите дату рождения цифрами — она нужна для персональных расчётов.\nНапример: 12.03.1990 или 1990-03-12. Вернуться к этому шагу можно через /start.",
  profileDobInvalid: "Не разобрала дату. Напишите, например, 12.03.1990 или 1990-03-12.",
  ...
  dayDisabled: "Расклад на сутки сейчас недоступен.",
  dayAlready: "Расклад на сутки уже открыт сегодня. Завтра будет новый.",
  ...
  reminderMorning: "Доброе утро. Если нужно — откройте расклад на сутки.",
  reminderEvening: "Вечер — хорошее время вернуться к раскладу на сутки.",
  ...
  reactivation: (days: number) =>
    [
      ...
      "Если хотите, расклад на сутки или новый расклад ждут в меню.",
...
export function collectBodyCopySamples(): string[] {
  ...
  return [
    ...
    copy.reminder("Расклад на сутки ждёт вас", "Бесплатный расклад на сутки готов."),
    copy.reminderOpen,
