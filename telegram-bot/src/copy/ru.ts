...
export const copy = {
  ...
  homeHero: (name?: string | null) => {
    ...
    return [
      ...
      "",
      "Все услуги — в меню внизу: расклады, карта дня, матрица, натальная карта, Дизайн Человека, ладонь, аура, обряды и совместный разбор.",
      "",
      "Там же — дневник, память, история, руны, профиль, настройки и поддержка. Тот же аккаунт, что на zovus.ru.",
    ].join("\n");
  },
  ...
  homePhotoFailed: "Салон открыт. Все услуги, история, руны и поддержка — в меню внизу.",
