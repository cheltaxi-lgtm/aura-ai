...
export const copy = {
  about: [
    ...
    "",
    "Карты, наставники и разборы — в одном аккаунте: здесь и на сайте.",
  ...
  homeHero: (name?: string | null) => {
    ...
    return [
      ...
      "",
      "Приватный салон, где можно задать вопрос и получить ясный ориентир: расклад, карта дня, матрица или фото — в одном месте с сайтом.",
      "",
      "Салон помнит важное из ваших сессий. Не нужно каждый раз начинать с нуля — следующий ответ уже чуть ближе к вам.",
      "",
      "Меню внизу — выберите, с чего начать.",
    ].join("\n");
  },
  ...
  profileMemoryAsk: [
    "Персональная память",
    "",
    "Салон может помнить важное из ваших сессий — чтобы следующие разборы продолжали вашу линию, а не начинали знакомство заново.",
    "",
    "Сведения можно смотреть, править и полностью очистить в кабинете. Выбор всегда можно изменить.",
  ].join("\n"),
