...
$RequiredArtifacts = @(
  ...
  "scripts/migrations/117_migrate_async_report_queue.sql",
  "scripts/migrations/117_migrate_async_report_queue.down.sql",
  "src/lib/async-report-flags.ts",
  "src/lib/async-report-circuit-breaker.ts",
  "src/lib/async-report-notify.ts",
  "src/lib/async-job-runners/index.ts",
  ...
  "src/app/api/human-design/chart/route.ts",
  "src/app/api/human-design/report/route.ts",
  "src/app/dizayn-cheloveka/page.tsx",
  "src/app/cabinet/human-design/page.tsx",
  "scripts/verify-human-design.mjs",
  ...
  "hosting/async-jobs-shared.env.keys",
  "hosting/ASYNC_JOBS_ENV.md",
  "src/lib/async-worker-health.ts",
