...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    modules: [
      ...
      { id: "chat", title: "Вопрос по раскладу", native: true, url: null },
      { id: "runes", title: "Руны / баланс", native: true, url: `${site}/runy?${utm}` },
      { id: "cabinet", title: "Кабинет", native: true, url: `${site}/cabinet?${utm}` },
      { id: "astrology", title: "Натал / астрология", native: true, url: `${site}/cabinet/astrology?${utm}` },
      { id: "numerology", title: "Нумерология", native: true, url: `${site}/cabinet?${utm}` },
      { id: "rituals", title: "Обряды", native: true, url: `${site}/cabinet?${utm}` },
      { id: "joint", title: "Совместный расклад", native: true, url: `${site}/joint-reading?${utm}` },
      { id: "diary", title: "Дневник", native: true, url: `${site}/cabinet?${utm}` },
      { id: "memory", title: "Память салона", native: true, url: `${site}/cabinet?${utm}` },
      { id: "photo", title: "Фото-расклад", native: true, url: `${site}/photo-rasklad?${utm}` },
