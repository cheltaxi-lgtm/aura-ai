...
const NUMEROLOGY_DIRECTIONS = [
  ...
  {
    title: "Рассчитать нумерологию",
    text: "Путь и личный год по одной дате — сразу калькулятор, без обзора методов.",
    action: "Транзакционный вход: два числа, затем матрица.",
    href: "/numerology/rasschitat",
  },
  {
    title: "Личный год",
    text: "Фон текущего календарного года по дате рождения.",
    action: "Когда вопрос «какой у меня год», а не «кто я».",
    href: "/numerology/lichnyy-god",
  },
  {
    title: "Число души по имени",
    text: "Гласные имени — внутренний мотив, без даты.",
    action: "Когда хотите отделить «чего хочу» от числа пути.",
  ...
  },
  {
    ...
    text: "Три аркана нижней линии матрицы — повторяющиеся темы, не приговор.",
    action: "Открывается только вместе с полной схемой по дате.",
    href: "/numerology/karmicheskiy-khvost",
  },
  {
    title: "Канал денег",
    text: "Зона ресурса на схеме матрицы — не прогноз дохода.",
    action: "Когда нужен каркас «как у меня с деньгами», а не расклад на заказ.",
