...
const TOPICS = {
  ...
  "destiny-matrix": {
    ...
    description:
      "Полная матрица судьбы онлайн бесплатно: октаграмма, кармический хвост, комфорт, каналы денег и любви, возраст, узел периода. Живой разбор с Эвелиной и ведение в Telegram.",
    intro:
...
const MATRIX_FAQ = [
  ...
  },
  {
    ...
    a: "Это полная матрица Zovus (matrix-v2) по мотивам популярного 22-арканного метода — не лицензия «официальной Ладини», а свой расчёт с живым разбором. Полезность растёт, когда вы соотносите арканы с реальной ситуацией.",
  },
  {
