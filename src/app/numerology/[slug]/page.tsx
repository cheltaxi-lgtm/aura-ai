...
const TOPICS = {
  ...
  "destiny-matrix": {
    ...
    description:
      "Бесплатная схема матрицы судьбы по дате рождения: 16 зон на 22 арканах, кармический хвост, комфорт, каналы денег и любви, возраст и узел периода. Персональный разбор с Эвелиной оплачивается отдельно.",
    intro:
      "Введите дату рождения — и получите расчётную схему на 22 арканах: зона комфорта, кармический хвост, каналы, родовые линии, точки возраста и узел периода. Схема бесплатна; персональная интерпретация и ведение — с Эвелиной.",
  },
  "matrica-sovmestimosti": {
    title: "Совместимость матриц судьбы",
    description:
      "Бесплатный расчёт совместимости по матрице судьбы двух дат: оценка Zovus (авторская аналитика, не научная метрика), сильные стороны, зоны напряжения, любовь, деньги и комфорт. Полный разбор пары — с Эвелиной.",
    intro:
      "Введите две даты рождения — и получите бесплатную оценку совместимости матриц: сильные стороны, зоны напряжения, любовь, деньги и комфорт. Это авторская аналитика Zovus, не научная метрика. Полный разбор пары открывается после входа.",
  },
  "detskaya-matritsa": {
...
const MATRIX_FAQ = [
  ...
  },
  {
    ...
    a: "Бесплатно доступна расчётная схема и короткие смысловые акценты по зонам, включая узел периода. Персональная интерпретация с диалогом, слоем «Небо» и ведением — в сессии с Эвелиной и в Telegram.",
  },
  {
...
const MATRIX_PAIR_FAQ = [
  {
    ...
    a: "Две даты сравниваются по ключевым точкам матрицы: комфорт, любовь, деньги, напряжение и годовой фон. Оценка Zovus — авторская аналитика, не научная метрика и не «процент любви».",
  },
  {
    q: "Нужна ли регистрация для расчёта пары?",
    a: "Для бесплатной оценки — нет. Полный разбор пары с Эвелиной открывается после входа; та же пара дат сохраняется.",
  },
  {
