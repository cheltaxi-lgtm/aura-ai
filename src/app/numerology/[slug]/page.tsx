...
const TOPICS = {
  ...
  "destiny-matrix": {
    ...
    description:
      "Полная матрица судьбы онлайн бесплатно: расчётная схема из 16 зон на 22 арканах, кармический хвост, комфорт, каналы денег и любви, возраст, узел периода. Персональный разбор с Эвелиной и ведение в Telegram.",
    intro:
  ...
  "matrica-sovmestimosti": {
    ...
    intro:
      "Введите две даты рождения — и получите бесплатный preview совместимости матриц: оценка Zovus, сильные стороны, зоны напряжения, любовь, деньги и комфорт. Оценка — авторская аналитика Zovus, не научная метрика. Полный разбор пары открывается после входа.",
  },
  "detskaya-matritsa": {
