...
const MATRIX_FAQ = [
  ...
  },
  {
    ...
    a: "Арканы считаются по каноническому 22-арканному правилу (свёртка вычитанием 22), поэтому цифры совпадают с общепринятыми таблицами. Разметка зон — наша адаптация популярного метода, не лицензия «официальной Ладини». Полезность растёт, когда вы соотносите арканы с реальной ситуацией.",
  },
  {
