      ...
      {isDestinyMatrix ? (
        <>
          ...
          <SeoSection title="Как устроен полный разбор">
            ...
            <p>
              {sessionCost} ᚢ — разовая оплата за AI-разбор Эвелины с сохранением и{" "}
              {PRICING.MATRIX_INCLUDED_QUESTIONS} вопросами в чате. Цифры матрицы остаются
              бесплатными; повторно за ту же дату платить не нужно.
            </p>
            <p>
              Далее — один следующий шаг: личный год, совместимость или натальная карта в экосистеме
              Zovus.
            </p>
          </SeoSection>
        </>
