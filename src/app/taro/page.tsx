...
const faq = [
  {
    ...
    a: "Да. Первый расклад из трёх карт открывается на главной до регистрации. После входа сохранятся те же карты — выбирать заново не нужно. Карта дня — отдельный ежедневный ритуал.",
  },
  {
  ...
  return (
    <SeoPageShell breadcrumbs={breadcrumbs}>
      ...
      <SeoSection title="Бесплатный расклад Таро онлайн" id="besplatno">
        <p>
          Три карты на главной — первый персональный расклад до регистрации. После входа сохранятся
          те же карты — выбирать заново не нужно. Карта дня — отдельный ежедневный ритуал. Для глубины —
