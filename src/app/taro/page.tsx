...
const faq = [
  {
    ...
    a: "Да. Первый расклад из трёх карт открывается на главной до регистрации. После входа сохранятся те же карты — выбирать заново не нужно. Ежедневный ритуал — «Расклад на сутки».",
  },
  {
    ...
    <SeoPageShell breadcrumbs={breadcrumbs}>
      ...
      <SeoSection title="Бесплатный расклад Таро онлайн" id="besplatno">
        <p>
          ...
          те же карты — выбирать заново не нужно. Ежедневный ритуал — «Расклад на сутки». Для глубины —
