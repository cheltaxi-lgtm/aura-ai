...
export const metadata: Metadata = buildSeoMetadata({
  ...
  description:
    "Таро онлайн: расклады на отношения, будущее и карьеру. 78 карт с толкованиями, гадание с ИИ-наставником. Три карты бесплатно до регистрации — на Zovus.",
  path: "/taro",
});
  ...
  return (
    <SeoPageShell backHref="/" backLabel="На главную">
      ...
      <p className="mt-4 text-white/70">
        Готовые вопросы, понятные схемы раскладов и разбор с ИИ-наставником в чате. Можно изучать
        значения арканов или сразу задать свой вопрос.
      </p>
      ...
      <SeoSection title="Бесплатный расклад Таро онлайн" id="besplatno">
        <p>
          ...
          карты доступен раз в сутки. Для глубины — полные схемы с мастером.
        </p>
