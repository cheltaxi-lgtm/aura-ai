...
const faq = [
  ...
  },
  {
    ...
    a: "Да. На главной: вопрос → три карты → краткий ответ → полный разбор тех же карт после входа. Банковская карта на старте не нужна.",
  },
];
        ...
        <div className="grid gap-3">
          <div className="rounded-xl border border-white/10 bg-white/5 p-4">
            ...
            <p className="mt-1 text-sm text-white/70">
              Вопрос → три карты → краткий ответ → полный разбор тех же карт после входа.
              Выбирать карты заново не нужно.
            </p>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 p-4">
