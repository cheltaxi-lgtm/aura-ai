...
export const metadata: Metadata = buildSeoMetadata({
  ...
  description:
    "Расшифровка Таро по фото онлайн: загрузите снимок домашнего расклада или отметьте карты вручную — Zovus распознает арканы и даст персональный разбор с мастером. Первый фото-расклад со скидкой.",
  path: "/photo-rasklad",
});
