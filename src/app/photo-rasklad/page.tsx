  ...
  return (
    ...
    <SeoPageShell>
      ...
      <p className="mt-4 text-white/70">
        ...
        Разложите карты дома, сфотографируйте расклад или отметьте символы вручную — мастер Zovus

        перерисует их в колоду сервиса, проверит с вами результат и даст трактовку с возможностью

        продолжить диалог в чате.
