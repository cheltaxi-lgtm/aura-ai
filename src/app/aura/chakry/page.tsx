...
const HUB = {
  ...
  intro:
    "Чакры в Zovus — семь центров на силуэте карты. Основной цвет поля виден в кратком результате. Состояние каждого центра раскрывается в полном разборе без медицинских диагнозов.",
  sections: [
    {
  ...
  faq: [
    {
      q: "Почему в кратком результате чакры скрыты?",
