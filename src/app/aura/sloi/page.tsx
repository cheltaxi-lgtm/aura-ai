  ...
  sections: [
    {
      ...
      body: "Выберите слой, чтобы понять его роль. Затем снимите своё поле: состояние слоя откроется в полном разборе. В кратком результате показано общее значение слоёв, без личного статуса.",
    },
  ],
  faq: [
    {
