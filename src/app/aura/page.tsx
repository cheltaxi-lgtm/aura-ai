...
const FAQ = [
  ...
  },
  {
    ...
    a: "Ядро ауры в традиции стабильно неделями. Один снимок на календарный день: повтор откроет тот же результат, а не новую лотерею цвета. На следующий день могут сдвинуться слои и чакры — ядро обычно остаётся.",
  },
  {
    q: "Сколько стоит полный разбор?",
    a: `Снимок ауры и короткий тизер — бесплатно. Полный разбор — ${DEFAULT_RUNE_COSTS.AURA_READING} ᚢ, первый разбор со скидкой 50%. Один разбор на день: повтор сегодня откроет тот же текст и не спишет руны снова.`,
  },
];
