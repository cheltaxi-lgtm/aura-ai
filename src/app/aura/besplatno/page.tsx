...
export const metadata: Metadata = buildSeoMetadata({
  ...
  description:
    "Бесплатный снимок ауры по фото: основной цвет и краткий результат. Полный разбор слоёв и чакр — отдельно. Чем это отличается от кирлиан-фотографии и медицинских измерений.",
  path: "/aura/besplatno",
});
...
const faq = [
  ...
  },
  {
    ...
    a: "Один снимок для каждого человека в календарный день. Повторный снимок сегодня откроет тот же результат.",
  },
];
  ...
  return (
    <SeoPageShell breadcrumbs={breadcrumbs}>
      ...
      <p className="mt-4 text-white/70">
        Бесплатно — снимок и краткий результат по цвету. Полный разбор слоёв открывается отдельно.
        Хаб{" "}
      ...
      <SeoSection title="Что открывается без оплаты">
        <ul className="list-disc space-y-2 pl-5 text-white/70">
          ...
          <li>Основной цвет и краткий результат</li>
          <li>Один результат для каждого человека в календарный день</li>
        </ul>
      </SeoSection>
