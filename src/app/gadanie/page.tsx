...
const METHODS = [
  ...
  },
  {
    ...
    text: "Один ежедневный расклад на утро, день и вечер — бесплатно раз в сутки после входа.",
  ...
  {
    title: "Что бесплатно",
    text: "Первый расклад без регистрации, расклад на сутки, калькуляторы матрицы, натала и числа пути.",
...
const faq = [
  ...
  },
  {
    ...
    a: "Да. Первый расклад из трёх карт на главной открывается до регистрации и после входа сохраняет те же карты. Отдельно после входа доступен один бесплатный расклад на сутки. Полные сессии с разбором в чате — за руны по тарифу сервиса.",
  },
  {
