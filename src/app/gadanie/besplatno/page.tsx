...
export const metadata: Metadata = buildSeoMetadata({
  ...
  description:
    "Что доступно бесплатно на Zovus: первый расклад из трёх карт без регистрации, расклад на сутки после входа, калькуляторы матрицы, натала и числа пути.",
...
const FREE_ITEMS = [
  ...
  },
  {
    ...
    text: "После входа — один бесплатный ежедневный расклад на утро, день и вечер. Он сохраняется в кабинете.",
    href: "/?daily=1",
    cta: "Открыть расклад на сутки",
  },
  {
...
const faq = [
  ...
  {
    q: "Что платное?",
    a: "Развёрнутый диалог с мастером, повторные расклады сверх бесплатного лимита, полные отчёты матрицы и натала, фото-расклад и полный разбор ладони после краткого результата. На старте банковская карта не нужна.",
  },
  {
    q: "Первый расклад и расклад на сутки — это одно и то же?",
    a: "Нет. Первый расклад отвечает на ваш вопрос до регистрации. После входа доступен один ежедневный расклад на сутки.",
  },
];
...
export default function GadanieBesplatnoPage() {
  const structuredData = buildForecastStructuredData({
    ...
    description:
      "Что доступно бесплатно на Zovus: первый расклад, расклад на сутки, матрица, натал и число пути.",
    path: "/gadanie/besplatno",
    faq,
  });
