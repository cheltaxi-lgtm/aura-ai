...
const faq = [
  ...
  {
    q: "Это карта дня?",
    a: "Нет. Для ежедневной практики есть «Расклад на сутки». Первый расклад из трёх карт на главной отвечает на вопрос и после входа не перетягивается.",
  },
];
  ...
  return (
    <SeoPageShell breadcrumbs={breadcrumbs}>
      ...
      <SeoSection title="Как не смешать форматы">
        <p>
          Гостевой триплет на главной — ответ на ваш вопрос. Расклад на сутки — отдельная страница и
