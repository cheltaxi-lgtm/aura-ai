...
const FAQ = [
  ...
  },
  {
    ...
    a: `Снимок и краткий результат — бесплатно. Полный разбор — ${DEFAULT_RUNE_COSTS.PALM_READING} ᚢ, первый разбор со скидкой 50%. Каждая ладонь оплачивается отдельно; повтор того же снимка сегодня откроет тот же текст и не спишет руны снова.`,
  },
];
