...
export default function CabinetTabHero({ title, subtitle, kicker }: Props) {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[rgba(201,162,74,0.18)] bg-[#141210] px-5 py-4 sm:px-6 sm:py-5">
      <div className="relative">
        ...
        <h2 className="mt-1 font-display text-xl font-medium text-[#ede6da] sm:text-2xl">{title}</h2>
