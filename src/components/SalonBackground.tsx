  ...
  return (
    <div className="salon-bg" aria-hidden="true">
      ...
      <svg className="salon-bg__lines" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice">
        <g fill="none" stroke="rgba(232,199,126,0.22)" strokeWidth="0.8">
        ...
        <g fill="none" stroke="rgba(201,162,74,0.16)" strokeWidth="0.6">
        ...
        <g fill="rgba(232,199,126,0.55)">
          <circle cx="340" cy="220" r="1.6" />
          <circle cx="280" cy="360" r="1.2" />
          <circle cx="460" cy="400" r="1.8" />
          <circle cx="860" cy="180" r="1.5" />
          <circle cx="820" cy="320" r="1.1" />
          <circle cx="980" cy="280" r="1.7" />
          <circle cx="220" cy="480" r="1.3" />
          <circle cx="340" cy="640" r="1.4" />
          <circle cx="760" cy="600" r="1.2" />
          <circle cx="880" cy="680" r="1.6" />
          <circle cx="520" cy="160" r="1.3" />
