      ...
      <div className="ritual-cta-banner__inner">
        ...
        <div className="ritual-cta-banner__copy">
          ...
          <p className="ritual-cta-banner__text">
            ...
            и ворота. Расчёт выполняется по астрономическим эфемеридам; точность результата
            зависит от указанного времени рождения.
          </p>
          <p className="mt-1 text-xs text-white/40">
            Бодиграф и «Опора» бесплатно · полный разбор Эвелины —{" "}
