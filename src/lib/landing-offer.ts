...
export const LANDING_FAQ_ITEMS = [
  {
    ...
    answer:
      "Да. На главной открываются три карты до регистрации — с коротким смыслом символов. После входа расклад сохраняется в кабинете, а первые уточнения в сеансе включены. Полный разбор и дополнительные действия — за руны ᚢ.",
  },
  {
...
> = {
  a: {
    ...
    heroSubtitle:
      "Сформулируйте вопрос, откройте символы и получите короткий смысл расклада ещё до регистрации. Сохранить результат и продолжить диалог можно после входа.",
  },
  b: {
    heroTitle: "Три карты Таро — ясный ориентир по вопросу",
    heroSubtitle:
      "Откройте символы за минуту, без оплаты и без регистрации. Полный разбор и диалог с мастером — после входа.",
  },
  c: {
    heroTitle: "Бесплатный расклад из трёх карт",
    heroSubtitle:
      "Вопрос об отношениях, решении или будущем — короткий смысл до регистрации, сохранение в кабинете после входа.",
  },
};
...
export function buildLandingOfferCopy(
  ...
  const heroEyebrow = "Приватный расклад · 3 карты бесплатно";
  ...
  const heroMicrocopy = "Без оплаты · 18+ · сохраняется после регистрации";
  ...
  const seoFreeParagraph =
    "На главной можно открыть три карты бесплатно. После регистрации расклад сохраняется в кабинете. Полные расклады, фото-анализ, нумерология и обряды — по тарифу в рунах ᚢ.";
