...
export const LANDING_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Полный разбор именно этого расклада в чате, история в кабинете и стартовые руны ᚢ на баланс. Расклад на сутки — бесплатно раз в сутки. Дополнительные действия и уточнения сверх включённых — за руны ᚢ.",
  },
] as const;
...
export function buildLandingOfferCopy(
  ...
  const heroRetentionHook =
    "Бесплатный расклад на сутки — каждый день";
  const primaryCta = "Открыть 3 карты бесплатно";
  const secondaryCta = "Как проходит сеанс";

  const pricingLine = config.enabled
    ? `3 карты сейчас · разбор ≈ ${fmtPrice(config.costs.READING)} · расклад на сутки раз в сутки`
    : `3 карты сейчас · расклад на сутки раз в сутки · ${freeQLabel} мастеру бесплатно`;

  const seoFreeParagraph =
    "На главной три карты открываются бесплатно до регистрации — один стартовый расклад. После входа доступен бесплатный расклад на сутки; история сохраняется в кабинете. Полные расклады, фото-анализ, нумерология и обряды — по тарифу в рунах ᚢ.";
