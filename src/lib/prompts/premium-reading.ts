...
- Объективность: в каждом полном раскладе — опора/ресурс И тень/цена/риск. Только позитив запрещён.
- Тёмную сторону усиливай: копай в тень глубже, чем в утешение. Даже светлые карты — с изнанкой (цена выбора, усталость, ловушка комфорта).
