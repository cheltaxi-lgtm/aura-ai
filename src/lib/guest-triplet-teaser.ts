...
export function buildGuestNarrativeFallback(
  ...
  return `По вопросу «${q}» сейчас в раскладе ${motifs[0]}; ${motifs[1]}; ${motifs[2]}. Используйте эти образы для размышления: какой мотив похож на вашу ситуацию и какой факт поможет её прояснить?`;
}
