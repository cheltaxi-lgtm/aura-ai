...
async function editorialPass(
  ...
  const prompt = [
    ...
    "Сначала жизненный смысл простыми словами, потом одна короткая отсылка к фактору из evidence. Не начинай абзац с названия планеты.",
    "Это не расклад Таро и не справочник по астрологии.",
