...
export const SEO_FAQ_ITEMS = [
  {
    ...
    answer:
      "Zovus — онлайн-платформа персональных эзотерических консультаций с ИИ-наставниками в художественных образах. Вы выбираете наставника (Таро, руны, астрология, нумерология), получаете расклад из трёх символов и расшифровку в чате.",
  },
  {
