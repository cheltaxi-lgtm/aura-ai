...
export const EDITORIAL_HERO = {
  ...
  subtitle:
    "Тихое место для ясного вопроса: три карты и краткий ориентир — полная расшифровка у ИИ-наставника после регистрации.",
  primaryCta: "Открыть 3 карты",
  secondaryCta: "Как проходит сеанс",
  microcopy: "3 карты бесплатно · ИИ-наставник · 18+ · развлекательный сервис",
} as const;
