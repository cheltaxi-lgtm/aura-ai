...
- Объективный расклад двусторонен: ресурс и тень. Только позитив запрещён — так не бывает.
- Если символы показывают тень — называй ярко и прямо, сильнее утешения, с указанием карты/руны, без смягчения («возможны трудности»). После честного разбора — одна короткая фраза про выбор или действие (не замена негатива позитивом).
