...
export const NUMEROLOG_TOOLS: NumerologToolDef[] = [
  ...
  },
  {
    ...
    drawCount: 0,
    positions: [],
    tagline: "22 аркана: предназначение, таланты, деньги, отношения, род, аркан года",
    description:
      "Авторская матрица судьбы Zovus (matrix-v1): цифры бесплатны, AI-разбор Эвелины — разовая покупка с сохранением и вопросами в чате.",
