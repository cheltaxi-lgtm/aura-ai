...
export const SPREAD_HUBS: SpreadHubConfig[] = [
  {
    ...
    seoTitle: "Расклад Таро на отношения — гадание онлайн | Zovus",
    seoDescription:
      "Расклад Таро на отношения и любовь: чувства партнёра, будущее пары, верность. Более 80 готовых вопросов — бесплатно онлайн на Zovus.",
    h1: "Расклады на любовь и отношения",
    intro:
      "Вопросы о связи, дистанции, верности и перспективе пары. Готовая схема карт и спокойный разбор — с возможностью уточнить в чате.",
    category: "love",
    featuredSlugs: [
      "chto-on-chuvstvuet",
      "lyubit-li-on-menya",
  ...
  },
  {
    ...
    intro:
      "Когда тревога о верности сильнее фактов — расклад показывает динамику пары без допроса и без паники.",
    category: "love",
    featuredSlugs: [
      "est-li-izmena",
      "izmenshchik-li-on",
  ...
  },
  {
    ...
    seoDescription:
      "Расклад Таро на будущее: что ждёт в ближайшие недели и месяцы. Гадание на картах с трактовкой — бесплатно и с мастером на Zovus.",
