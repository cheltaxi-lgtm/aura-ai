...
export const SPREAD_HUBS: SpreadHubConfig[] = [
  {
    ...
    seoDescription:
      "Расклад Таро на отношения и любовь: чувства партнёра, будущее пары, верность. Более 80 готовых вопросов онлайн; три карты бесплатно до регистрации — на Zovus.",
