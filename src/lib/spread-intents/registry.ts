...
const SEEDS: IntentSeed[] = [
  // Love
  {
    ...
    intro: "Спокойный взгляд на чувства и дистанцию — когда важно понять, что происходит между вами.",
    positions: LOVE5,
  ...
  },
  {
    ...
    intro: "Пауза, сближение или разрыв — карты показывают вектор, а не гарантированную дату.",
    positions: LOVE5,
  ...
  },
  {
    ...
    intro: "Не допрос, а разбор связи: что реально между вами и где слова расходятся с действием.",
    positions: LOVE5,
  ...
  },
  {
    ...
    intro: "Что остаётся за кадром — страх, сомнение или просто невысказанное.",
    positions: LOVE5,
  ...
  },
  {
    ...
    intro: "Что стоит за тишиной: избегание, перегруз или холод к связи.",
    positions: LOVE5,
  ...
  },
  {
    ...
    intro: "Перспектива пары: где сила, где трение и к чему ведёт текущий вектор.",
    positions: LOVE7,
  ...
  },
  {
    ...
    intro: "Расклад о доверии и внимании — без паники и без роли детектива.",
    positions: LOVE5,
  ...
  },
  {
    ...
    intro: "Короткий ответ: шаг навстречу или пауза — что сейчас честнее.",
    positions: ["Ответ"],
  ...
  },
  {
    ...
    intro: "Два пути: держаться за связь или отпустить — без давления «правильно».",
    positions: S5,
  ...
  },
  {
    ...
    intro: "Динамика пары: силы, слабые места и совет — без обещания даты.",
    positions: LOVE7,
  ...
  },
  {
    ...
    intro: "Разбор двоих: где связь держит, где трение и что можно прояснить.",
    positions: LOVE7,
    related: ["perspektiva-otnosheniy", "budem-li-my-vmeste", "chto-mezhdu-nami", "sovmestimost-druzhba"],
    featured: true,
    requiresPartnerInfo: true,
  },
  {
    slug: "sovmestimost-druzhba",
    title: "Совместимость: дружба",
    category: "love",
    spreadId: "love-7",
    question: "Насколько крепка наша дружба?",
    intro: "Глубокий разбор дружеской связи — доверие, поддержка и точки роста.",
    positions: LOVE7,
    related: ["sovmestimost-pary", "sovmestimost-biznes", "chto-mezhdu-nami"],
    requiresPartnerInfo: true,
  },
  {
    slug: "sovmestimost-biznes",
    title: "Совместимость: бизнес-партнёрство",
    category: "career",
    spreadId: "love-7",
    question: "Насколько мы совместимы как бизнес-партнёры?",
    intro: "Разбор делового союза — сильные стороны, риски и совет по сотрудничеству.",
    positions: LOVE7,
    related: ["sovmestimost-pary", "sovmestimost-druzhba"],
    requiresPartnerInfo: true,
  },
  {
    ...
    intro: "Пауза или разрыв: что видно сейчас и куда клонится связь.",
    positions: S5,
  ...
  },
  {
    ...
    intro: "Мысли и намерения партнёра — спокойно, без накрутки.",
    positions: LOVE5,
  ...
  },
  {
    ...
    category: "future",
    spreadId: "triplet",
    question: "Что подскажут карты на сегодня?",
    intro: "Один расклад на утро, день и вечер.",
