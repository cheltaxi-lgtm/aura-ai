...
export const BULK_INTENT_SEEDS: BulkSeed[] = [
  ...
  money(
    "pochemu-net-dohoda",
    "Почему нет дохода",
    "Почему у меня нет стабильного дохода?",
    "Почему доход стоит и где открыть поток."
  ),
  ...
  money(
    "kakaya-finansovaya-cel",
    "Финансовая цель",
    "Какая финансовая цель мне сейчас важнее?",
    "Какая цель сейчас важнее и с чего начать."
  ),
  ...
  choice(
    "kakoy-variant-luchshe",
    "Какой вариант лучше",
    "Какой вариант для меня лучше?",
    "Какой вариант ближе и чем он обернётся."
  ),
  ...
  family(
    "pochemu-obida-na-rod",
    "Обида на род",
    "Почему я злюсь на свой род?",
    "Где корень обиды на род и что помогает исцелению."
  ),
