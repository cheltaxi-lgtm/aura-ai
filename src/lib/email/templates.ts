...
export function dailyReminderEmailHtml(name: string, siteUrl?: string): string {
  ...
  return shell(
    `<p>Здравствуйте, ${safeName}!</p>
     <p>Новый день — новая энергия. <strong>Бесплатные</strong> 3 карты дня ждут вас — узнайте, что несёт сегодняшний день.</p>
  ...
  const body =
    inactiveDays <= 7
      ? `<p>Вы давно не заходили — а карты уже готовы к <strong>бесплатному</strong> раскладу на сегодня.</p>
         <p style="font-size:14px;color:#555">Один клик — и вы снова в потоке: 3 карты дня, бонусные руны и ваши сохранённые сессии.</p>`
      : `<p>Мы скучаем! Прошло уже две недели — за это время накопилось много нового: расклады, бонусы и персональные разборы.</p>
         <p style="font-size:14px;color:#555">Вернитесь на минуту: бесплатные 3 карты дня и ежедневные руны ждут вас.</p>`;
  return shell(
    `<p>Здравствуйте, ${safeName}!</p>
     ${body}
     ${cta(`${url}/?dailyCards=1`, "Вернуться на Zovus")}`,
