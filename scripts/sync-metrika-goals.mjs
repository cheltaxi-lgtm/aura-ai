...
const DISPLAY_NAMES = {
  ...
  rune_checkout_started: "Оплата рун — переход в checkout",
  rune_purchase_attempted: "Оплата рун — нажатие на пополнение",
  rune_purchase_failed: "Оплата рун — ошибка до перехода",
