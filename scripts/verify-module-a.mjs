...
const checks = [
  ...
  () => mustExist("scripts/lib/android-release-files.mjs"),
  () => mustExist("scripts/verify-android-release.mjs"),
  () => mustExist("scripts/write-android-release-manifest.mjs"),
  () => mustInclude("src/lib/android-release.ts", "releaseConsistent"),
  () => mustInclude("src/lib/app-shell-update-check.ts", "releaseConsistent"),
  () => mustInclude("mobile/capacitor.config.ts", "localhost"),
