...
const CORE_PRIORITY = [
  ...
  `${base}/gadanie`,
  `${base}/gadanie/da-net`,
  `${base}/gadanie/karta-dnya`,
  `${base}/gadanie/besplatno`,
  `${base}/gadanie/na-lyubov`,
  `${base}/gadanie/na-budushchee`,
  `${base}/goroskop-na-segodnya`,
  `${base}/numerology/chislo-sudby`,
  `${base}/numerology/rasschitat`,
  `${base}/numerology/lichnyy-god`,
  `${base}/natal-ili-matrica`,
  `${base}/natalnaya-karta/sovmestimost`,
  `${base}/voskhodyashchiy-znak`,
  `${base}/taro/tri-karty`,
  `${base}/numerology/chislo-dushi`,
  `${base}/numerology/karmicheskiy-khvost`,
  `${base}/numerology/kanal-deneg`,
  `${base}/lenormand/na-lyubov`,
  `${base}/lenormand/da-net`,
  `${base}/lenormand/na-rabotu`,
  `${base}/runy/na-lyubov`,
  `${base}/runy/na-rabotu`,
  `${base}/runy/na-dengi`,
  `${base}/cards/mladshie-arkany`,
  `${base}/runy`,
  `${base}/lenormand`,
