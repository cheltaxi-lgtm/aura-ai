...
export const ASTROLOGY = [
  ...
  ["mangala", "Мангала", "Mars graha"],
  ["budha", "Будха", "Mercury graha"],
  ["guru-jupiter", "Гуру", "Jupiter graha"],
  ["shukra", "Шукра", "Venus graha"],
  ["shani", "Шани", "Saturn graha"],
  ["rahu", "Раху", "Rahu node"],
  ["ketu", "Кету", "Ketu node"],
  ["aries", "Овен", "Aries zodiac"],
  ["taurus", "Телец", "Taurus zodiac"],
  ["gemini", "Близнецы", "Gemini zodiac"],
  ["cancer", "Рак", "Cancer zodiac"],
  ["leo", "Лев", "Leo zodiac"],
  ["virgo", "Дева", "Virgo zodiac"],
